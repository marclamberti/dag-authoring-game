...
`,
  ...
  },
  {
    ...
    kind: "lab",
    level: 3,
    title: "Level 3: AI drafts, you approve",
    prompt: "Run the AI pipeline: an agent finds a customer, the LLM drafts their email, you approve, it sends.",
    tasks: [
      "Trigger the ai_release_notes DAG",
      "find_recipient (an AI agent) calls the randomuser.me API for a customer",
      "draft_email (@task.llm) writes a release note personalized to them",
      "human_approval pauses for YOU — open it and Approve",
      "send_email runs only after your approval",
    ],
